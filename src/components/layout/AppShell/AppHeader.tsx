...
export function AppHeader({
  ...
  return (
    <>
      ...
      <header
        className="fixed left-0 right-0 top-0 z-50 border-b border-gray-200 bg-gray-050 dark:border-gray-800 dark:bg-gray-950 hdr:hidden"
        style={{
      ...
      {mobileMenuOpen && (
        <div
          className="fixed inset-x-0 bottom-0 z-40 animate-fade-in hdr:hidden"
