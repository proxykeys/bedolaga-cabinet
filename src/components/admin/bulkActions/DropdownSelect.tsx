  ...
  return (
    <div className={cn('relative', className)}>
      <select
        ...
        className="w-full appearance-none rounded-xl border border-dark-700 bg-dark-800 px-3 py-2.5 pr-8 text-sm text-dark-100 outline-none transition-colors focus:border-dark-400/40"
      >
        {options.map((o) => (
