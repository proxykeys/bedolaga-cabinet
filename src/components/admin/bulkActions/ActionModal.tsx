        ...
        return (
          <div>
            ...
            <input
              ...
              className="w-full rounded-xl border border-dark-700 bg-dark-800 px-3 py-2.5 text-sm text-dark-100 outline-none transition-colors focus:border-dark-400/40"
            />
          </div>
        );
      case 'change_tariff':
